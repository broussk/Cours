...
public class ServeurUDP {
    ...
    private static String nomFichierClePriv = "priveeServeur.bin";
    private static String nomFichierClePubl = "publiqueServeur.bin";
    ...
    public static void main(String[] args) {
        ...
        RSA rsaServeur = new RSA(nomFichierClePriv, nomFichierClePubl);
