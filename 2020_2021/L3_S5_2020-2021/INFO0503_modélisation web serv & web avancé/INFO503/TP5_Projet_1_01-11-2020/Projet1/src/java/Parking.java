public class Parking {
	...
	public int getNumParking() {return this.numParking;}
	public Place[] getPlaces() {return this.places;}

	public void setPlaces(Place[] places) {this.places = places;}
	
	public void addPlace(Place place) {
		Place[] places = new Place[this.places.length +1];
		for(int i = 0; i < this.places.length; i++) {
			places[i] = new Place(this.places[i]);
		}
		places[places.length -1] = new Place(place);
		this.places = places;
	}
	...
	public String toString() {
		return "numParking : " + numParking + " places : " + this.placesString() + "";
	}
}