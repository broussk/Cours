...
public class TestCatalogue {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<voituresALL.length; i++) {
			System.out.println(voituresALL[i].toString());
		}
		...
		System.out.println(catalogue0.toString());
		
		catalogue1.addVoitureToList(v5);
		catalogue1.addVoitureToList(v0);
		System.out.println(catalogue1.toString() + "\n");
		
		catalogue1.retirerVoitureToList(v3);
		System.out.println(catalogue1.toString() + "\n");
		catalogue1.retirerVoitureToList(v0);
		System.out.println(catalogue1.toString() + "\n");
		
		Voiture[] voituresListeCatalogue = catalogue1.getVoituresListInTabOfVoiture();
		
		for(int i=0; i<voituresListeCatalogue.length; i++) {
			System.out.println(voituresListeCatalogue[i].toString());
		}
	}
