...
public class Zoo implements IZoo{
	...
	public Zoo(int nbCage){
		if (nbCage>maximum) throw new ArithmeticException("Nombre de cage superieur au maximum !");
		else if (nbCage<minimum) throw new ArithmeticException("Nombre de cage inferieur au minimum !");  
